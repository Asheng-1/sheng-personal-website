  ...
  learning: `${head("关于我 | Sheng")}${nav("/learning")}
    <main><section id="about"><h1>关于我</h1>
      <div class="about__console">
        ...
        <article class="about__biography" aria-label="个人介绍"><p>我来自广东广州，从事过 AI Agent、模型数据策略与评测相关工作。曾参与 Agent 与多模态模型项目</p><p>我比较关注如何把模糊的任务需求转化为清晰、可执行的标准，也在尝试通过流程优化和自动化工具，提高数据生产与评测效率。</p><p>这个网站会持续记录我的项目实践、作品和思考，以及我对 AI Agent、具身智能和多模态交互的关注。</p></article>
      </div>
